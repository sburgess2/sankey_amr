...
Next I've added my caption to the plot. I have used `plot_annotation()` to add the caption because, I'm using the library patchwork to join the two plots together.

```{r caption2}
#Note this results in a caption twice under each plot
p_final <- p_join +
  plot_annotation(caption = social_caption, title = title) &
  theme(plot.caption = element_textbox_simple(margin = margin(t = 30, r = 5, b = 5, l = 5)),
