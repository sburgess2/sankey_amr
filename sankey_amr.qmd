...
caption1 <- "Beta-lactam resistance in E. coli predominantly occurs through the acquisition of genes that encode beta-lactamases (marked in shades of yellow, orange, and red, according to their enzyme group), but can also occur through mutations in genes (marked with an asterix) encoding outer membrane proteins (light blue) or efflux pumps (dark blue). This Sankey diagram illustrates how beta-lactam resistance genes can be grouped based on mechanism (reduced permeability, efflux pump and enzymatic inactivation by different beta-lactamases) along with the subgroups of beta-lactams that they confer resistance to. The beta-lactamase enzymes have been grouped into penicillinases, oxcillinases, IRT (inhibitor resistant TEM), ESBL, AmpC, and carbapenemases. One example of each gene variant is shown. However, sometimes there are differences in resistance range between different enzyme variants."
