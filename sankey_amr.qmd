...
psc <- ps +
  ...
  theme(plot.caption.position = "plot", 
        plot.caption = element_textbox_simple(
          hjust = 0.5, 
          margin = margin(t = 30, r = 5, b = 5, l = 5))
        )
...
phc <- ph + labs(caption = caption2) +
  theme(plot.caption.position = "plot", 
        plot.caption = element_textbox_simple(
          hjust = 0,
          margin = margin(t = 40, r = 10, b = 5, l = 10)))
...
```{r title}
title <- "Mechanisms of beta-lactam resistance in <i>Escherichia coli</i>"
