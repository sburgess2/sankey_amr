...
mechanisms <- c("Enzymatic inactivation", "Target alteration", "Target protection", "Efflux pump", "Target replacement", "Poor prodrug activation")
...
p3 <- htmlwidgets::onRender(p2, '
  function(el, x) {
    const boldNames = [
      ...
      "Poor prodrug activation", "Macrolides"
    ];
